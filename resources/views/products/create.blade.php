            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="productApproved_id" id="productApproved_id" value={{2}} />
                        <input type="hidden" name="productScrapped_id" id="productScrapped_id" value={{3}} />
                        <input type="hidden" name="maintenance_id" id="maintenance_id" value={{3}} />
